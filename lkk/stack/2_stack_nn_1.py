...
res['Id'] = list(test_id)
res['Score'] = list(re)  
res.to_csv('../stack_cache/stcking_ince___sfceshi_diejia_test_model1_shuffle.csv')

st_train1=pd.DataFrame()
st_train1['train1']=daset_blend_train[:,0]
st_train1['y']=train_data['Score']
st_train1.to_csv('../stack_cache/stcking_ince___sfceshi_diejia_train_model1_shuffle.csv')