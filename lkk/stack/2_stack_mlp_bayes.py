...
if __name__ == "__main__":
    ...
    train_data[['Id','mlp_ci_feat']].to_csv('../stack_cache/5_fold_mlp_ci_feat.csv',index=False)
    test_data[['Id','mlp_ci_prob']].to_csv('../stack_cache/5_fold_mlp_ci_prob.csv',index=False)
    ...
    train_data[['Id','bayes_ci_feat']].to_csv('../stack_cache/5_fold_bayes_ci_feat.csv',index=False)
    test_data[['Id','bayes_ci_prob']].to_csv('../stack_cache/5_fold_bayes_ci_prob.csv',index=False)
    ...
    train_data[['Id','mlp_zi_feat']].to_csv('../stack_cache/5_fold_mlp_zi_feat.csv',index=False)
    test_data[['Id','mlp_zi_prob']].to_csv('../stack_cache/5_fold_mlp_zi_prob.csv',index=False)
    ...
    train_data[['Id','bayes_zi_feat']].to_csv('../stack_cache/5_fold_bayes_zi_feat.csv',index=False)
    test_data[['Id','bayes_zi_prob']].to_csv('../stack_cache/5_fold_bayes_zi_prob.csv',index=False)
    ...
    model_name = 'keras_model_mlp_ci_'
    ...
    train_data[['Id','keras_mlp_ci_feat']].to_csv('../stack_cache/5_fold_keras_mlp_ci_feat.csv',index=False)
    test_data[['Id','keras_mlp_ci_prob']].to_csv('../stack_cache/5_fold_keras_mlp_ci_prob.csv',index=False)
    ...
    train_data[['Id','keras_bayes_ci_feat']].to_csv('../stack_cache/5_fold_keras_bayes_ci_feat.csv',index=False)
    test_data[['Id','keras_bayes_ci_prob']].to_csv('../stack_cache/5_fold_keras_bayes_ci_prob.csv',index=False)
    ...
    model_name = 'keras_model_mlp_zi_'
    ...
    train_data[['Id','keras_mlp_zi_feat']].to_csv('../stack_cache/5_fold_keras_mlp_zi_feat.csv',index=False)
    test_data[['Id','keras_mlp_zi_prob']].to_csv('../stack_cache/5_fold_keras_mlp_zi_prob.csv',index=False)
    ...
    train_data[['Id','keras_bayes_zi_feat']].to_csv('../stack_cache/5_fold_keras_bayes_zi_feat.csv',index=False)
    test_data[['Id','keras_bayes_zi_prob']].to_csv('../stack_cache/5_fold_keras_bayes_zi_prob.csv',index=False)
