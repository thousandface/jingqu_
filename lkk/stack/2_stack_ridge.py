...
if __name__ == "__main__":
    ...
    train_data[['Id','ridge_ci_feat']].to_csv('../stack_cache/5_fold_ridge_ci_feat.csv',index=False)
    test_data[['Id','ridge_ci_prob']].to_csv('../stack_cache/5_fold_ridge_ci_prob.csv',index=False)
    ...
    train_data[['Id','ridge_zi_feat']].to_csv('../stack_cache/5_fold_ridge_zi_feat.csv',index=False)
    test_data[['Id','ridge_zi_prob']].to_csv('../stack_cache/5_fold_ridge_zi_prob.csv',index=False)