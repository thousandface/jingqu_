...
VECTOR_DIR = '../stack/word2vec/lg_data_model_comment_256dim_zi'
from keras.utils import plot_model
from keras.layers import Embedding
...
res['Id'] = list(test_id)
res['Score'] = list(re)  
res.to_csv('../stack_cache/stcking_ince___sfceshi_diejia_test_model1_no_shuffle_zi.csv')

st_train1=pd.DataFrame()
st_train1['train1']=daset_blend_train[:,0]
st_train1['y']=train_data['Score']
st_train1.to_csv('../stack_cache/stcking_ince___sfceshi_diejia_train_model1_no_shuffle_zi.csv')